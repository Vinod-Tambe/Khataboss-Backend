 ...
 * Example: fineAmt=20, fineEmiNo=2 → 2 overdue EMIs = ₹20, 4 overdue = ₹40.
 */
function computeFinanceFine(finance, emis = [], asOfDate = null) {
...
function sumPaidFineAndCollect(moneyTrans = []) {
  let finePaid = 0;
  let collectPaid = 0;
